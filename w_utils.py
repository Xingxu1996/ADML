...
class FunctionNegativeTripletSelector(TripletSelector):
    ...
    def __init__(self, margin1, margin2, negative_selection_fn, relation_selection_fn, cpu=True):
...
def SemihardNegativeTripletSelector(margin1, margin2,  cpu=False): return FunctionNegativeTripletSelector(margin1=margin1, margin2=margin2,
                                                                                  relation_selection_fn=lambda x: semihard_negative(x, margin1),
                                                                                negative_selection_fn=lambda x: semihard_relation(x, margin2),
                                                                                  cpu=cpu)
